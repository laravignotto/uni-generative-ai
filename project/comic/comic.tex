...
\begin{minipage}{1.2\textwidth}
    \begin{tikzpicture}
        ...
        \node [text width=7cm, align=center, rectangle callout, fill=white, draw, callout relative pointer={(0,0)}] at (3,6) {
        ...
        \node [text width=6.5cm, align=center, rectangle callout, fill=white, draw, callout relative pointer={(0,0)}] at (-6,-7) {
...
\begin{minipage}{0.49\textwidth}
    \begin{tikzpicture}
        ...
        \node [text width=2.5cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(1,1)}] at (-1.8,-2) {
            \englang{THE SIGNAL PATTERNS ARE PERSISTENT, LILY}
            \italang{I MODELLI DI SEGNALE SONO PERSISTENTI, LILY.}
            };
        \node [text width=2.5cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(-0.5,1)}] at (2,-3.6) {
...
\begin{minipage}{1\textwidth}
    \begin{tikzpicture}
        ...
        \node [dashed, text width=3cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(0,0)}] at (-3,4) {
            \englang{THEY WANT US TO HEAR THEM.}
            \italang{VOGLIONO CHE LI ASCOLTIAMO.}
            };
        \draw [dashed, fill=white, draw] (-2,3) ellipse (.5cm and .25cm);
        \draw [dashed, fill=white, draw] (-1,2.5) ellipse (.25cm and .125cm);
    \end{tikzpicture}
\end{minipage}%
...
\begin{minipage}{0.49\textwidth}
    \begin{tikzpicture}
        ...
        \node [text width=4.5cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(.5,1)}] at (-.5,-3.5) {
...
\begin{minipage}{0.49\textwidth}
    \begin{tikzpicture}
        ...
        \node [text width=5cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(0,1.5)}] at (0,-3.5) {
        ...
        \node [text width=3.5cm, align=center, rectangle callout, fill=white, draw, callout relative pointer={(0,0)}] at (-1.5,4) {
...
\begin{minipage}{0.49\textwidth}
    \begin{tikzpicture}
        ...
        \node [dashed, text width=2.5cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(0,0)}] at (-1.8,-0.5) {
            \englang{THEY'RE ASKING FOR HELP. I CAN FEEL IT.}
            \italang{STANNO CHIEDENDO AIUTO. LO SENTO.}
            };
        \draw [dashed, fill=white, draw] (-1,1.3) ellipse (.5cm and .25cm);
        \draw [dashed, fill=white, draw] (-0.5,1.8) ellipse (.25cm and .125cm);
    \end{tikzpicture}
\end{minipage}%
\hfill
\begin{minipage}{0.49\textwidth}
    \begin{tikzpicture}
        ...
        \node [text width=5cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(-0.5,1)}] at (1,-4) {
...
\begin{minipage}{0.49\textwidth}
    \begin{tikzpicture}
        ...
        \node [text width=4.5cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(0,-1)}] at (0.5,2) {
...
\begin{minipage}{0.49\textwidth}
    \begin{tikzpicture}
        ...
        \node [text width=4cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(0,1.5)}] at (0,-3.5) {
...
\begin{minipage}{0.49\textwidth}
    \begin{tikzpicture}
        ...
        \node [text width=3cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(-0.5,0)}] at (2,-1) {
...
\begin{minipage}{0.49\textwidth}
    \begin{tikzpicture}
        ...
        \node [text width=5cm, align=center, ellipse callout, fill=white, draw, callout relative pointer={(0,1)}] at (0,-3) {
